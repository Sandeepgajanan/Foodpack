...
const Faq = () => {
  ...
  return (
    <section className="w-full bg-slate-50 h-screen max-sm:h-full ">
        ...
        <div className="flex gap-8 max-sm:flex-col max-sm:gap-6 max-sm:mt-8">
          <div className="w-[70%] max-sm:w-full min-h-screen max-sm:min-h-fit">
            <div className="space-y-4">
              {data.map((faq) => (
                <div key={faq.id} className="rounded-lg shadow-md bg-white">
          ...
          {/* Contact Section */}
          <div className="w-fit max-sm:w-full h-fit bg-zinc-200 rounded-3xl p-8 max-sm:p-6 flex items-center flex-col">
