...
const TestimonialCard = ({
  ...
  return (
    <div
      key={testimonial.id}
      className="bg-slate-100 p-6 w-[35vw] h-[20vw] rounded-2xl shadow-md hover:shadow-xl transition-shadow duration-300 max-sm:w-full max-sm:h-full relative max-sm:mt-4"
    >
